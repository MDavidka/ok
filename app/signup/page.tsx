...
export const metadata: Metadata = {
  title: "Start free trial — ok",
  description: "Create your ok account and launch your first phone number in minutes.",
}
...
<section className="relative w-full ">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 md:py-24 lg:grid-cols-2 lg:px-8">
        <div className="space-y-5">
          ...
          <h2 className="text-balance text-3xl font-semibold tracking-tight sm:text-4xl">Create your account</h2>
